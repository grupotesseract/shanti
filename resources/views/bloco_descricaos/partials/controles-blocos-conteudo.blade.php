<div class='container-controles text-center'>
    <div class="col-xs-6">
        @if ($qnt > 1)
            @if ($key != 0)
            <div>
                <a class="btn btn-info btn-xs btn-controle-ordem" href="javascript:void(0);" onclick="alteraOrdemAjax(this,'{{ route('bloco_descricaos.altera-ordem', ['id' => $blocoDescricao->id, 'variacao' => -1]) }}')">
